 ...
 *
 * This is a utility function for testing LiveData objects.
 *
 * @param time The time to wait for the LiveData to receive a value.
 * @param timeUnit The unit of time for the `time` parameter.
 * @param afterObserve A lambda to be executed after the observer is registered.
